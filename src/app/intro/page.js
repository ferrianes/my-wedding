  ...
  return (
    <div className=''>
      ...
      <div className="flex flex-col pt-[16%] relative">
        <h1 className={`${marcellus.variable} font-marcellus text-3xl text-center text-[#5A5F4F]`}>The Wedding Of</h1>
        <div className='mx-auto relative mt-3'>
          ...
          <div className='w-[160px] absolute top-[55px] right-[70px]'>
            <TypingEffect key={1} text="Tia" speed={200} className={`${alexBrush.variable} font-alex-brush text-6xl text-[#5A5F4F] text-left`} animationVariant={animationVariantsTextLeft} />
            ...
            <TypingEffectBackward key={3} text="Rian" speed={200} className={`${alexBrush.variable} font-alex-brush text-6xl text-[#5A5F4F] text-right`} animationVariant={animationVariantsTextRight} />
          </div>
        </div>
      </div>
      <div className="flex w-max mx-auto">
        <div className="w-[300px]">
          <motion.p className={`${marcellus.variable} font-marcellus text-base text-[#5A5F4F] text-center`} variants={animationVariantsFadeUp} initial="initial" animate="animate">
      ...
      <div className='absolute bottom-0 left-0'>
        <motion.div variants={animationVariantsFadeLeft} initial="initial" animate="animate">
